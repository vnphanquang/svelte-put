...
```typescript
declare function inlineSvg(input?: InlineSvgInput | InlineSvgInput[]): PreprocessorGroup;
```
...
|  --- | --- | --- |
|  input | InlineSvgInput \| InlineSvgInput\[\] | _(Optional)_ configuration options |
