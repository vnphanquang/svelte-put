<script>
  ...
  import DemoLimitScreen from './examples/limit-screen.svelte';
  import DemoLimitAncestor from './examples/limit-ancestor.svelte';
  import DemoLimitDelta from './examples/limit-delta.svelte';
...
```bash
/// title=npm
npm install --save-dev @svelte-put/movable@^3.0.0
```

```bash
/// title=pnpm
pnpm add -D @svelte-put/movable@^3.0.0
```

```bash
/// title=yarn
yarn add -D @svelte-put/movable@^3.0.0
```
...
```svelte
/// src=./examples/limit-screen.svelte
/// title=limit-screen.svelte
```
...
```svelte
/// src=./examples/limit-ancestor.svelte
/// title=limit-ancestor.svelte
```
...
```svelte
/// title=limit-delta-syntax.svelte
...
```svelte
/// src=./examples/limit-delta.svelte
/// title=limit-delta.svelte
```

### Limit to Single Axis

```svelte
/// title=limit-single-axis-syntax.svelte
...
```svelte
/// src=./examples/limit-single-axis.svelte
/// title=limit-single-axis.svelte
```
