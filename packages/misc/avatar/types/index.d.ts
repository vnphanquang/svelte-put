declare module '@svelte-put/avatar' {
  ...
  export class Avatar extends SvelteComponent<AvatarProps, {}, AvatarSlots> {}
  /**
...
declare module '@svelte-put/avatar/helpers' {
  /**
   * Builds a {@link https://ui-avatars.com | UIAvatar } url
   * @param input - name for UIAvatar or object of options
   * */
