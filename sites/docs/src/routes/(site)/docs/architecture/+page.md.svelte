...
Because of the philosophies above, you will find that the majority of packages rely primarily on [Svelte action](https://svelte.dev/docs/svelte-action) and extend on [Svelte rune](https://svelte.dev/blog/runes)  to encapsulate only the necessary logics and leave the UI to be defined by users.
