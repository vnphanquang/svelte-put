...
<section>
  ...
  <section>
    ...
    <div class="not-prose c-gtable-4 max-w-full direct-children:p-4">
      <p>Name</p>
      <p>Type</p>
      <p>Mutability</p>
      <p>Description</p>
      ...
      <p>
        ...
        not have an <code>id</code> either
      </p>
      ...
      <p>
        ...
        is enabled in <code>toc</code> parameters
      </p>
  ...
  <section>
    ...
    <div class="not-prose c-gtable-4 max-w-full direct-children:p-4">
      ...
      <p class="font-semibold">readonly</p>
      <p>
        Added to the element where <code>IntersectionObserver</code> is used when
        <code>observe</code> is turned on and references the associated toc element
      </p>
      ...
      <p>
        ...
        references the <code>id</code> of the active matching element<br /><span
          class="c-callout-info my-2 inline-block"
      ...
      <p>
        ...
        usage of the complementary <ResourceLink id={SECTION_IDS.toclink}>toclink</ResourceLink> action
      </p>
      ...
      <p>
        ...
        and set to <code>true</code> when the linked toc element is active
      </p>
    </div>
  </section>
